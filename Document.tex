...
\begin{document}
	...
	\section{Summary of the sggw.b data}
		...
		We can see that the area is similar to the Chi-squared distribution, the peak is around 3000 square feet. Most houses have 3 bedrooms, 1 bathroom and 1 or 2 stories
		
		\begin{center}
			\includegraphics[scale=0.6]{plotB3}
		\end{center}
		
		Most of the houses has a metro station nearby at over 80 percents, and a parking space at 70. The place being furnished or having a basement has around 40 percent chance. The least chance is to get an air conditioning or being in the popular area.
	...
	\section{kNN regression data analysis}
		Why did we choose kNN? It is perfect for predicting the value of the houses, as it chooses the most similar places, and checks the price with them. We used FNN (Fast Nearest Neighbor Search Algorithms and Applications) library, in which it is possible to do regression on k nearest neighbours model
		
		
		% to do: opisz punkt 2 i 3, dodaj plot z różnymi k i rmse
