...
x <- c(25, 35, 40, 50, 55, 60, 70, 89, 92, 100, 115)
y <- c(0, 0, 0, 1, 0, 1, 1, 1, 1, 1, 1)
...
png('../Plots/plot1Ac.png', width = 1500, height = 1500, res = 150, type = "cairo", bg="white")
# ---------- Plot -------------------
plot(x, y, pch = 16, cex = 1.5, col = col_points,
     xlab = "Hours", ylab = "Probability",
     main = "Logistic Regression for Ex. 1A c)",
     ylim = c(0, 1),
     xlim = c(min(x), max(x)))
grid()
